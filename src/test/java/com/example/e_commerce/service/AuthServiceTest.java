...
class AuthServiceTest {
    ...
    class RegisterTests {
        @DisplayName("Register should create user when email not exists")
        @Test
        ...
        @DisplayName("Register should throw exception when customer role not found")
        @Test
        ...
        @DisplayName("Register should create user when avatar is null")
        @Test
        ...
        @DisplayName("Register should upload avatar when avatar provided")
        @Test
    ...
    @DisplayName("Login")
    class LoginTests {
        @DisplayName("Login should return tokens when credentials valid")
        @Test
    ...
    class RefreshTokenTests {
        @DisplayName("Refresh token should return new access token when session valid")
        @Test
        ...
        @DisplayName("Refresh token should throw exception when session revoked")
        @Test
        ...
        @DisplayName("Refresh token should throw exception when session expired")
        @Test
    ...
    @DisplayName("Logout")
    class LogoutTests {
        @DisplayName("Logout should revoke session when token valid")
        @Test
        ...
        @DisplayName("Logout should throw exception when session not found")
        @Test
    ...
    class LoginWithGoogleTests {
        @DisplayName("Login with google should create user when user not exists")
        @Test
        ...
        @DisplayName("Login with google should not create user when user exists")
        @Test
        ...
        @DisplayName("Login with google should throw exception when role not found")
        @Test
